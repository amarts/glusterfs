                  ...
                  int32_t keep_size, off_t offset, size_t len, dict_t *xdata)
{
    ...
    STACK_UNWIND_STRICT(fallocate, frame, gf_zero_ret, 0, &statpre, &statpost, rsp_xdata);
    return 0;
              ...
              size_t len, dict_t *xdata)
{
    ...
    STACK_UNWIND_STRICT(discard, frame, gf_zero_ret, 0, &statpre, &statpost, rsp_xdata);
    return 0;
...
overwrite:
    ...
    STACK_UNWIND_STRICT(zerofill, frame, gf_zero_ret, 0, &statpre, &statpost, rsp_xdata);
    return 0;
...
out:
    ...
    STACK_UNWIND_STRICT(seek, frame, (ret == -1 ? gf_failure : gf_zero_ret), err,
...
out:
    ...
    SET_RET(fin_ret, op_ret);
    STACK_UNWIND_STRICT(readv, frame, fin_ret, op_errno, &vec, 1, &stbuf, iobref,
                        rsp_xdata);
...
out:
    ...
    SET_RET(fin_ret, op_ret);
    STACK_UNWIND_STRICT(xattrop, frame, fin_ret, op_errno, xattr_rsp, xdata_rsp);
